        ...
        result.update({
            ...
            "argv": [
                *validator.CLI_INVARIANT_ARGV[:-3], "--sandbox", "read-only", "--json",
                "--add-dir", contract["tempRoot"], "--add-dir", contract["cacheRoot"],
                "--add-dir", contract["dependencyRoot"],
            ...
            "inputCommit": contract["inputCommit"],
            "supervisorCommit": None,
            "supervisorCommitTree": None,
            "supervisorCommitScriptSha256": validator.COMMIT_HELPER_SHA256,
            "supervisorCommitError": None,
