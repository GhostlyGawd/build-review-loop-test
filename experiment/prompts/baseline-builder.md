# Exact prompt: baseline builder

The operator may replace only `{{CANDIDATE_LABEL}}`, `{{COMMON_START_COMMIT}}`, `{{WALL_CLOCK_DEADLINE_ISO}}`, and `{{TOKEN_BUDGET}}`. Do not add guidance.
